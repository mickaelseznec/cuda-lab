...
__global__
void k_cuda_adder(uint8_t *d_in_buffer_1, uint8_t *d_in_buffer_2, uint32_t width, uint8_t height, uint8_t *d_out_buffer)
{
...
void cuda_adder(uint8_t *in_buffer_1, uint8_t *in_buffer_2, uint32_t width, uint32_t height, uint8_t *out_buffer)
{
    ...
    dim3 blockSize(1, 1);
    k_cuda_adder<<<1, blockSize>>>(d_in_buffer_1, d_in_buffer_2, width, height, d_out_buffer);
